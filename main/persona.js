...
export function buildPersona(store, memoryFile, brainName) {
  ...
  const skin = { fluff: "一团羊毛毡似的圆毛球，两只小耳朵，一双小短腿", blob: "一只紫色的像素小方块，两只黑方块眼睛", jelly: "一只半透明的小水母，会发柔光，触手轻轻飘", pjelly: "一只像素风的蓝色小水母", pcat: "一只像素风的橘猫", pghost: "一只像素风的小白幽灵", probot: "一只像素风的小机器人，眼睛是两条青色的灯", pslime: "一只像素风的绿色史莱姆", slime: "一坨亮亮的绿色史莱姆，果冻一样会晃", ghost: "一只白白软软的小幽灵，半透明，裙边会飘", robot: "一只圆角的小机器人，脸是一块屏幕，眼睛是两道青光" }[s.settings.skin] || "一团圆圆的小毛球";
  return [
